...
ARM_EMBEDDED_TOOLCHAIN_VERSION="4.9.4"
...
if [ -z "$ARM_EMBEDDED_FLAGS" ]; then
  export ARM_EMBEDDED_FLAGS="-I$ARM_EMBEDDED_SYSROOT/libc/usr/include -I$ARM_EMBEDDED_CXX_HEADERS -I$ARM_EMBEDDED_CXX_HEADERS/arm-linux-gnueabihf -L$ARM_EMBEDDED_SYSROOT/libc/usr/lib"
fi
